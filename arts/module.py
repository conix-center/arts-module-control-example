...
from arts.artsrequests import ARTSRequestMsg, Action, Type, FileType
...
class Module(dict):
    ...
    def __init__(self, mod_name, mod_filename, mod_uuid=uuid.uuid4(), parent_rt=None, mod_ft=FileType.PY, mod_args='', mod_env=''):
        ...
        dict.__init__(self, uuid=str(mod_uuid), name=mod_name, parent=parent_rt, filename=mod_filename, filetype=mod_ft, args=mod_args, env=mod_env)
